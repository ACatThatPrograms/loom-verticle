...
goog.exportSymbol('proto.TxHashList', null, global);
 ...
 * @constructor
 */
proto.TxHashList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.TxHashList.repeatedFields_, null);
};
goog.inherits(proto.TxHashList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.TxHashList.displayName = 'proto.TxHashList';
}
/**
 ...
 * @const
 */
proto.TxHashList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.TxHashList.prototype.toObject = function(opt_includeInstance) {
  return proto.TxHashList.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.TxHashList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.TxHashList.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.TxHashList}
 */
proto.TxHashList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.TxHashList;
  return proto.TxHashList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.TxHashList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.TxHashList}
 */
proto.TxHashList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.TxHashList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.TxHashList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.TxHashList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.TxHashList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.TxHashList.prototype.getTxHashList = function() {
 ...
 * @return {!Array.<string>}
 */
proto.TxHashList.prototype.getTxHashList_asB64 = function() {
 ...
 */
proto.TxHashList.prototype.getTxHashList_asU8 = function() {
...
proto.TxHashList.prototype.setTxHashList = function(value) {
 ...
 */
proto.TxHashList.prototype.addTxHash = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};


proto.TxHashList.prototype.clearTxHashList = function() {
  this.setTxHashList([]);
};
